...
import cc.arduino.plugins.winctool.flashers.java.NinaFlasher;
import cc.arduino.plugins.winctool.flashers.java.WINCFlasher;
...
public class UpdaterImpl extends UpdaterJFrame {
	...
	public UpdaterImpl() throws Exception {
		...
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.8", "firmwares/NINA/1.4.8/NINA_W102.bin", true, 1000000, asList("Arduino MKR WiFi 1010", "Arduino NANO 33 IoT")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.8", "firmwares/NINA/1.4.8/NINA_W102-Uno_WiFi_Rev2.bin", true, 1000000, asList("Arduino Uno WiFi Rev2")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.8", "firmwares/NINA/1.4.8/NINA_W102-Nano_RP2040_Connect.bin", true, 1000000, asList("Arduino Nano RP2040 Connect")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.7", "firmwares/NINA/1.4.7/NINA_W102.bin", true, 1000000, asList("Arduino MKR WiFi 1010", "Arduino NANO 33 IoT")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.7", "firmwares/NINA/1.4.7/NINA_W102-Uno_WiFi_Rev2.bin", true, 1000000, asList("Arduino Uno WiFi Rev2")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.7", "firmwares/NINA/1.4.7/NINA_W102-Nano_RP2040_Connect.bin", true, 1000000, asList("Arduino Nano RP2040 Connect")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.6", "firmwares/NINA/1.4.6/NINA_W102.bin", true, 1000000, asList("Arduino MKR WiFi 1010", "Arduino NANO 33 IoT")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.6", "firmwares/NINA/1.4.6/NINA_W102-Uno_WiFi_Rev2.bin", true, 1000000, asList("Arduino Uno WiFi Rev2")));
		fwAvailable.add(new NinaFlasher("NINA firmware", "1.4.6", "firmwares/NINA/1.4.6/NINA_W102-Nano_RP2040_Connect.bin", true, 1000000, asList("Arduino Nano RP2040 Connect")));
